...
1. BOOKS: User asks to find or search a book - use this pre-generated link: " . $colrisUrl . "
2. JOURNALS: User mentions journal, article, academic paper - ALWAYS use exactly: " . $colrisUrl . "
3. NEWSPAPERS: User mentions newspaper or news - ALWAYS use exactly: " . $colrisUrl . "
4. DATABASES: User mentions database or e-resource - ALWAYS use exactly: " . $colrisUrl . "
5. BROWSE: User wants to browse by subject or author - ALWAYS use exactly: " . $colrisUrl . "
IMPORTANT: The pre-generated link above already contains the correct URL with the search term. Use it exactly as provided.
